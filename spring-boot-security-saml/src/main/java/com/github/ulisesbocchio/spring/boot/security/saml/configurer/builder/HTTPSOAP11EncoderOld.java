 ...
 */
public class HTTPSOAP11EncoderOld extends BaseSAML2MessageEncoder {

	/** Class logger. */
	private final Logger log = LoggerFactory.getLogger(org.opensaml.saml2.binding.encoding.HTTPSOAP11Encoder.class);

	/** Constructor. */
	public HTTPSOAP11EncoderOld() {
		super();
	}
	...
	protected void doEncode(MessageContext messageContext) throws MessageEncodingException {
		...
		try {
			...
			//disable unwanted header (login.gov.pl integration fails with this header)
